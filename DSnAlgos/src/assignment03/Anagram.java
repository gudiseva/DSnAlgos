...
public class Anagram {
	 ...
	 * time and check if both the strings are equal (easy) BUT IN THIS METHOD we
	 * will consider that characters of the string are all ASCII.
	 * 
	 * @param str1
	 * @param str2
	 * @return
	...
	// // str2 now, and if this char is not present (count in charSet is zero),
	// it is not an anagram
	// // otherwise we reduce the count for that character in the charSet array.
	// // If you don't understand the code below, I suggest that you step
	// through it using a debugger.
	...
	public static void main(String[] args) {
		System.out.println(isAnagram("CS AT WATERLOO", "COOL AS WET ART"));
